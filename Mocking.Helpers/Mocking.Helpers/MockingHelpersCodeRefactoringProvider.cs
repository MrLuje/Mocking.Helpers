...
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(MockingHelpersCodeRefactoringProvider)), Shared]
    internal class MockingHelpersCodeRefactoringProvider : CodeRefactoringProvider
    {
